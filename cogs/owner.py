...
log = logging.getLogger("Cal_bot.owner")
...
class Owner:
    ...
    async def _set(self, ctx):
        """Changes Cal Bot's global settings."""
    ...
    async def version(self):
        """Shows Cal Bot's current version"""
